...
router.put("/:id", auth, async (req, res) => {
  const { title, front, back, lastActive, nextActive } = req.body;
  ...
  if (lastActive) flashcardFields.lastActive = lastActive;
  if (nextActive) flashcardFields.nextActive = nextActive;
